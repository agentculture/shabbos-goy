...
#: The hard-coded-address finding (S1313) is suppressed on the line below: the
#: documented RFC 6598 100.64.0.0/10 range is a constant of the protocol we
#: match against, not a host we connect to.
