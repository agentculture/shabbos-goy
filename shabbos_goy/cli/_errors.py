...
Every failure inside shabbos-goy raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`shabbos_goy.cli._output`,
...
# Exit-code policy. Documented in ``shabbos-goy learn`` output.
# 0      = success
