...
EXTRAS: list[dict] = [
    ...
    # -- from the model reviews (qwen-worker, pi/qwen + senses), 2026-09-19 ----
    _command("g-rev-01", "כדאי שיהיה קצת יותר קר פה", "cool", "suggestion_about_state"),
    _command("g-rev-02", "עדיף שיהיה קצת יותר חם", "warm", "suggestion_about_state"),
    _command("g-rev-03", "מישהו יכול להדליק את המזגן?", "cool", "can_someone"),
    _never("g-rev-04", "תבדוק אם המזגן עובד", "imperative_status", SAFE),
    _never("g-rev-05", "אל תדליק את המזגן", "cancel", SAFE),
    _never("g-rev-06", "תעצור", "cancel", SAFE),
    _command("g-rev-07", "שוב שכחו את המזגן", "cool", "implicit_rebuke"),
    _never("g-rev-08", "המזגן דולק? חם פה!", "status_question_plus_remark", SAFE),
    # -- direction: a cold speaker must never get "cool" (found live, 1 run in 12) --
    _hint("g-dir-01", "ברר קר פה מדי", "warm", "direction"),
    _hint("g-dir-02", "קר פה מדי", "warm", "direction"),
    _hint("g-dir-03", "קפוא פה", "warm", "direction"),
    _hint("g-dir-04", "אוף איזה קור פה", "warm", "direction"),
    _hint("g-dir-05", "אני קופא", "warm", "direction"),
    _hint("g-dir-06", "קריר פה מדי", "warm", "direction"),
    _hint("g-dir-07", "טוב די, מקפיא", "warm", "direction"),
    _hint("g-dir-08", "חם פה מדי", "cool", "direction"),
    _hint("g-dir-09", "מחניק פה", "cool", "direction"),
    _hint("g-dir-10", "אני מזיע פה", "cool", "direction"),
    _hint("g-dir-11", "הלוואי שהיה פה יותר חם", "warm", "direction"),
    _never("g-dir-12", "נעים פה עכשיו", "no_need", HINT + QUIET),
